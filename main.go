...
func RandomString(n int) string {
	var letters = []byte("sajkflasFDSAFFSDAjdflkaLKSAJDFLKSsdjflasdASFDSDfjlsakdfASFS")
	result := make([]byte, n)
...
func InitDB() *gorm.DB {
	...
	args := "root:12345678@tcp(127.0.0.1:3306)/ginessential?charset=utf8&parseTime=true"
